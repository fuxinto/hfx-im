...
public class ToastView: UIView {
    ...
    private let height1: CGFloat = 50
    ...
    public init(title: String, titleFont: UIFont = .systemFont(ofSize: 16, weight: .regular),
        ...
        UIWindow.fx.keyWindow().addSubview(self)
    ...
    private func setupConstraints() {
        ...
        let heightConstraint = NSLayoutConstraint(item: self, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: height1)
